...
describe("Spirits & Antagonists", () => {
  it("creates a spirit with Power/Finesse/Resistance stats", () => {
  ...
  it("spirit derived stats: Initiative, Defense, Speed", () => {
    const stats = spiritDerivedStats({
      power: 5,
      finesse: 3,
      resistance: 4,
      speciesFactor: 10,
  ...
  it("spirit rank table defines attribute dots and max essence", () => {
  ...
  it("numina reference data exists", () => {
